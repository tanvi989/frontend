...
import { ValidationCheck } from '@pf/types/face-validation';
...
interface FaceGuideOverlayProps {
  ...
  /** When false, hides the left-side validation checklist (face detection, distance, etc.). */
  showValidationChecklist?: boolean;
}

export function FaceGuideOverlay({ isValid, faceDetected, validationChecks, debugValues, showValidationChecklist = true }: FaceGuideOverlayProps) {
  return (
    <div className="absolute inset-0 pointer-events-none z-10">
      ...
      {/* Validation checklist on left side (optional) */}
